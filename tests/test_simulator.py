...
'''
    ...
    def test_html_report_writer_generates_layer_annotated_report(self) -> None:
        ...
        self.assertIn("Architecture Graph", html)
        self.assertIn("Timeline View", html)
        self.assertIn("stage-box", html)
        self.assertIn("kernel-node", html)
        self.assertIn("arch-legend", html)
        self.assertIn("resource-compute", html)
        self.assertIn("bottleneck-compute", html)
        self.assertIn("timeline-svg", html)
        self.assertIn("Compute lane", html)
